...
htmlmeta makes it easy to add HTML `<meta>` tags to your [R Markdown][rmarkdown] or [blogdown] pages and [Shiny] apps.

## Installation

You can install the released version of htmlmeta from [Github](https://github.com/gadenbuie/htmlmeta) with:
